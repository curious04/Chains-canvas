...
!(function (t, e) {
  ...
  return (function (t) {
          ...
          return function (v, d, g, y) {
            for (
              var b,
                ...
                O = 0,
                A = y || c,
                E = e ? A(v, _) : r || p ? A(v, 0) : void 0;
              _ > O;
              O++
            )
              if ((h || O in w) && ((m = S((b = w[O]), O, x)), t))
                if (e) E[O] = m;
                else if (m)
                  switch (t) {
                    case 3:
            ...
            [
              ...
              function (t, o) {
                ...
                for (var x = 0, w = 0, S = []; w < p.length; ) {
                  ...
                  if (
                    null === O ||
                    (_ = v(s(b.lastIndex + (d ? 0 : w)), p.length)) === x
                  )
                    w = u(p, w, g);
                  else {
    ...
    function (t, e, r) {
      ...
      t.exports = function (t, e, r, l, h, b, m) {
        o(r, e, l);
        var x,
          w,
          S,
        ...
        if (
          (P &&
            ...
            v !== Object.prototype &&
              ...
              (f ||
                i(x) === v ||
                (a ? a(x, v) : "function" != typeof x[g] && u(x, g, y)),
              c(x, O, !0, !0),
              f && (p[O] = y))),
          "values" == h &&
            j &&
          ...
          if (
            ...
            for (S in w) (d || A || !(S in E)) && s(E, S, w[S]);
          else n({ target: e, proto: !0, forced: d || A }, w);
        return w;
      };
    },
    function (t, e, r) {
      ...
      n(
        { target: "Array", proto: !0, forced: !p || !h },
        {
          splice: function (t, e) {
            ...
            if (((l.length = n), r < n)) {
              for (f = b; f < y - n; f++)
                (h = f + r), (p = f + n) in g ? (g[h] = g[p]) : delete g[h];
              for (f = y; f > y - n + r; f--) delete g[f - 1];
            } else if (r > n)
              for (f = y - n; f > b; f--)
                (h = f + r - 1),
                  (p = f + n - 1) in g ? (g[h] = g[p]) : delete g[h];
    ...
    function (t, e, r) {
      r(0)({ target: "String", proto: !0 }, { repeat: r(64) });
    },
    function (t, e, r) {
      var n = r(96);
      t.exports = function (t) {
    ...
    function (t, e, r) {
      ...
      t.exports = function (t) {
        ...
        if (
          ...
          for (r = new d((e = c(v.length))); e > x; x++)
            (h = b ? y(v[x], x) : v[x]), u(r, x, h);
        else
          for (
            p = (f = m.call(v)).next, r = new d();
            !(l = p.call(f)).done;
            x++
          )
            (h = b ? i(f, y, [l.value, x], !0) : l.value), u(r, x, h);
        return (r.length = x), r;
      };
    },
    function (t, e, r) {
      ...
      var n = r(54),
        ...
        c = function (t) {
          return function (e, r, c, u) {
            ...
            for (; t ? p >= 0 : f > p; p += h) p in l && (u = r(u, l[p], p, s));
            return u;
          };
        };
        ...
        { target: "Array", proto: !0, forced: !h || !v },
        {
          slice: function (t, e) {
            ...
            if (
              ...
              return g.call(f, h, v);
            for (
              n = new (void 0 === r ? Array : r)(y(v - h, 0)), l = 0;
              h < v;
              h++, l++
            )
              h in f && s(n, l, f[h]);
      ...
      n("replace", 2, function (t, e, r, n) {
        ...
        return [
          ...
          function (t, n) {
            ...
            for (var _, O = "", A = 0, E = 0; E < w.length; E++) {
              S = w[E];
              for (
                var j = String(S[0]),
                  C = f(p(c(S.index), h.length), 0),
                  P = [],
                  k = 1;
                k < S.length;
                k++
              )
                P.push(void 0 === (_ = S[k]) ? _ : String(_));
              var I = S.groups;
              if (v) {
                var R = [j].concat(P, C, h);
                void 0 !== I && R.push(I);
                var T = String(n.apply(void 0, R));
              } else T = m(j, h, C, P, I, n);
              C >= A && ((O += h.slice(A, C) + T), (A = C + j.length));
            }
            return O + h.slice(A);
          },
        ];
            ...
            if ((u < 0 && ((h = "-"), (u = -u)), u > 1e-21))
              if (
                ...
                for (d(l(10, n, 1), 0), n = e - 1; n >= 23; )
                  g(1 << 23), (n -= 23);
                g(1 << n), d(1, 1), g(2), (v = y());
              } else d(0, r), d(1 << -e, 0), (v = y() + a.call("0", f));
            return (v =
              f > 0
                ? h +
                  ((c = v.length) <= f
            ...
            switch (o) {
              ...
              case "rgba":
                var f = n(e),
                  ...
                  v = f[5],
                  d = f[6];
                if (p > 255 || h > 255 || v > 255 || d < 0 || d > 1 || !i(d))
                  break t;
                return { values: [].concat(A(p, h, v), [d]), a: d, type: o };
              case "hexa":
                var g = e[1];
                ...
                return (
                  ...
                  { values: [].concat(C(y), [b]), a: b, type: o }
                );
              case "hsla":
                var m = n(e),
                  x = m[3],
                  ...
                  S = m[5],
                  _ = m[6];
                if (x > 360 || w > 100 || S > 100 || _ < 0 || _ > 1 || !i(_))
                  break t;
                return { values: [].concat(j(x, w, S), [_]), a: _, type: o };
              case "hsva":
                var O = n(e),
                  P = O[3],
                  k = O[4],
                  I = O[5],
                  R = O[6];
                if (P > 360 || k > 100 || I > 100 || R < 0 || R > 1 || !i(R))
                  break t;
                return { values: [P, k, I, R], a: R, type: o };
            }
          }
        ...
        U = function (t, e, r) {
          ...
          for (
            ...
            var C = p.value,
              P = "t" === C || "b" === C,
              k = d[C],
              I = P ? ["top", "left"] : ["left", "top"],
              R = I[0],
              T = I[1],
              N = P ? [v.height, v.width] : [v.width, v.height],
              M = N[1],
              F = P ? [A, E] : [E, A],
              U = F[1],
              H = P ? [_, O] : [O, _],
      ...
      var W = (function () {
        function t(e) {
          ...
          (this._nanopop =
            ...
            (g = { margin: s }),
            (y =
              "object" != typeof (v = m) || v instanceof HTMLElement
                ? D({ reference: v, popper: d }, g)
                : v),
            {
              update: function () {
                var t =
          ...
          this._setupAnimationFrame = requestAnimationFrame(function t() {
            if (!x.offsetWidth) return requestAnimationFrame(t);
            w.setColor(e.default),
              w._rePositioningPicker(),
              e.defaultRepresentation &&
                ((w._representation = e.defaultRepresentation),
                w.setColorRepresentation(w._representation)),
              e.showAlways && w.show(),
              (w._initializingActive = !1),
              w._emit("init");
          });
        }
        var e = t.prototype;
                    ...
                    if (r.palette) {
                      ...
                      for (
                        ...
                        var d = p.value,
                          ...
                          y = d.color;
                        g.classList[
                          h === y.toHEXA().toString() ? "add" : "remove"
                        ]("pcr-active");
                      }
                      l.style.color = f;
                    }
